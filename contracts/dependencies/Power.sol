...
contract Power {
     ...
     */
    uint256 private constant FIXED_1 = 0x080000000000000000000000000000000; // 2 ** 127
    uint256 private constant FIXED_2 = 0x100000000000000000000000000000000; // 2 ** 128
    uint256 private constant MAX_NUM = 0x200000000000000000000000000000000; // 2 ** 129
    ...
    function power(uint256 _baseN, uint256 _baseD, uint32 _expN, uint32 _expD) internal view returns (uint256, uint8) {
        require(_baseN < MAX_NUM, "BaseN is too large");
        require(_baseN >= _baseD, "BaseN must be >= BaseD");
    ...
    function generalLog(uint256 _x) internal pure returns (uint256) {
        ...
        return res * LN2_NUMERATOR / LN2_DENOMINATOR; // \ln(2) \approx \frac{\text{LN2\_NUMERATOR}}{\text{LN2\_DENOMINATOR}}
    ...
    function findPositionInMaxExpArray(uint256 _x) internal view returns (uint8) {
        ...
        // Debug output
        revert(string(abi.encodePacked("findPositionInMaxExpArray failed: _x = ", Strings.toString(_x))));
//        assert(false);
        return 0;
    }
